...
import 'package:rocket_share/services/photon_sender.dart';
    ...
    if (Platform.isAndroid) {
      sharingOptions.add({
        ...
        "icon": SvgPicture.asset(
          ...
          colorFilter:
              const ColorFilter.mode(Colors.white38, BlendMode.srcATop),
          height: 60,
        ),
      });
    }
      ...
      await showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            ...
            content: const Text(
                'To get installed apps, you need to allow Rocket Share to query all installed packages. Would you like to continue ?'),
            actions: [
              ElevatedButton(
                onPressed: () {
                  Navigator.of(context).pop();
